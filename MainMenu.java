...
public class MainMenu{
	...
	*/
	...
	/**
	* a method that presents a menu of options to the user.  The user may take a Java SE 8 practice test, play a word guess with clues review game, play a hangman vocabulary review game, or exit the program.
	*/
	public void userOptions(){
		System.out.println("\n*********  JAVA CERTIFICATION PREP  *********");
		System.out.println("\nMake a choice:\n1.) Take Practice Test\n2.) Play Word Guess with Clues Review Game\n3.) Hangman Vocabulary Review \n4.) Exit");
		System.out.println("\n*********************************************");
			...
			int userChoice = Integer.parseInt(reader.readLine());	
				switch(userChoice){
					case 1: System.out.print("You selected: Take Practice Test");
						...
						newPT.loadQB();
						break;
					case 2: System.out.println("You selected: Play Word Guess with Clues");
						...
						newPT.loadGame();
						break;
					case 3: System.out.println("You selected: Play Hangman");
						newPT = new PracticeTest(6, true);
						newPT.playHangman();
						break;
